...
class HypothesisTesting:
    ...
    def test_rq1_temporal_alignment(self, data: pd.DataFrame) -> Dict:
        ...
        print("H1: Δρ < -0.15 (meaningful improvement)")
        ...
        if reject_h0:
            print("    → REJECT H0, SUPPORT H1")
            print("      Carbon-aware pricing achieves meaningful improvement")
            ...
            print("      Improvement does not exceed threshold")
    ...
    def test_rq2_seasonal_heterogeneity(self, data: pd.DataFrame) -> Dict:
        ...
        if reject_h0:
            ...
            print("      Intervention targets high-carbon periods effectively")
        else:
            print("    → FAIL TO REJECT H0")
            print("      Effect magnitude is similar across time periods")
    ...
    def calculate_emission_impacts(self, data: pd.DataFrame) -> Dict:
        ...
        print("\n  Context:")
        print("    Literature range for dynamic pricing: 5-25% emission reduction")
