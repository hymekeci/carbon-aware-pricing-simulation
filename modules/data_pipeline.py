...
class DataPipeline:
    ...
    def clean_carbon_data(self) -> pd.DataFrame:
        ...
        print("  [3.1] Standardized column names")
        
        # Parse datetime
        df['datetime'] = pd.to_datetime(df['datetime'], utc=True)
        df['datetime'] = df['datetime'].dt.tz_localize(None)
        print("  [3.2] Parsed datetime column")
        ...
        if missing_ci > 0:
            ...
            print("  [3.3] No missing carbon intensity values")
        ...
        print("  [3.5] Added temporal features")
    ...
    def clean_consumption_data(self) -> pd.DataFrame:
        ...
        print("  [4.1] Identified datetime and consumption columns")
        ...
        print("  [4.5] Added temporal features")
